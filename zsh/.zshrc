...
alias la="ls -a -h --color=always -v --group-directories-first"
alias las="ls -a -h -l --color=always --group-directories-first -v | less -R"
alias gs="git status"
alias gd="git diff"
alias ga="git add"
alias gc="git commit"
...
alias cpss='wl-copy ß'
alias gcc-arm='arm-none-eabi-gcc'
alias gcc-arm-no='arm-none-eabi-gcc -static -nostdlib'
alias gdb-arm='arm-none-eabi-gdb'
alias objdump='objdump -M intel --no-show-raw-insn --disassembler-color=on '
alias objdump-arm='arm-none-eabi-objdump --no-show-raw-insn --disassembler-color=on '
alias draw='lorien'
